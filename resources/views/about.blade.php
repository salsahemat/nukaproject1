                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 mb-2 mb-md-6">
                            <div class="box mt-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                    class="bi bi-cloud-sun-fill d-flex justify-content-center align-item-center" viewBox="0 0 16 16">
                                    <path
                        ...
                        <div class="col-12 col-md-4 mb-2 mb-md-6">
                            <div class="box mt-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                    class="bi bi-recycle d-flex justify-content-center align-item-center" viewBox="0 0 16 16">
                                    <path
                        ...
                        <div class="col-12 col-md-4 mb-2 mb-md-6">
                            <div class="box mt-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                    class="bi bi-tree-fill d-flex justify-content-center align-item-center" viewBox="0 0 16 16">
                                    <path
